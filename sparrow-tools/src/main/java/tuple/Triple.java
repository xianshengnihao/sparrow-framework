...
import com.sina.sparrow.core.utility.ObjectToolkit;
...
public abstract class Triple<L, M, R> implements Comparable<Triple<L, M, R>>, Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof Triple<?, ?, ?>) {
            ...
            return ObjectToolkit.equals(getLeft(), other.getLeft())
                && ObjectToolkit.equals(getMiddle(), other.getMiddle())
                && ObjectToolkit.equals(getRight(), other.getRight());
        }
        return false;
    }
