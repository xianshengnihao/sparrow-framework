...
//			return null;
//		}
//		if (PatternPool.NUMBERS.matcher( idCard).matches()) {
//			// 获取出生年月日
//			String birthday = idCard.substring(6, 12);
//			LocalDateTime birthDate = DateUtil.parseUUUUMMDD(birthday);
//			// 获取出生年(完全表现形式,如：2010)
...
//				sYear -= 100;
//			}
//			idCard18 = StringToolkit.builder().append(idCard, 0, 6).append(sYear).append(idCard.substring(8));
//			// 获取校验位
...
//		if (PatternPool.NUMBERS.matcher( code17).matches()) {
//			// 获取校验位
...
//		if (month == 2) {
//			// 在2月，非闰年最大28，闰年最大29
//			return day < 29 || (day == 29 && new GregorianCalendar().isLeapYear(year));
//		}
//		return true;
//	}
//
...
//		Assert.notNull(idCard, "id card must be not blank!");
...
//		return null == birthByIdCard ? null : DateUtil.parseUUUUMMDDToLocalDate(birthByIdCard);
//	}
//
//	/**
...
//		return getAgeByIdCard(idCard, LocalDateTime.now());
//	}
//
//	/**
...
//		return DateUtil.age(DateUtil.timeToLong(birth , "yyyyMMdd"),
//				Timestamp.valueOf(dateToCompare).getTime());
//	}
//
//
//
...
//		Assert.notNull(idCard , "idCard参数不能为空",null );
//		final int len = idCard.length();
//		if (len < CHINA_ID_MIN_LENGTH) {
