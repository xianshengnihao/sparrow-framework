...
public class ExceptionUtil {
	...
	public static String stacktraceToOneLineString(Throwable throwable, int limit) {
		Map<String, String> replaceCharToStrMap = new HashMap<>();
		replaceCharToStrMap.put(StrPool.RETURN, StrPool.SPACE);
		replaceCharToStrMap.put(StrPool.NEWLINE, StrPool.SPACE);
		replaceCharToStrMap.put(StrPool.TAB_C, StrPool.SPACE);
	...
	public static String stacktraceToString(Throwable throwable, int limit, Map<String, String> replaceCharToStrMap) {
		...
		if (!CollToolkit.isEmpty(replaceCharToStrMap)) {
			...
			return StrToolkit.substring(exceptionStr, limit);
		}
	}
