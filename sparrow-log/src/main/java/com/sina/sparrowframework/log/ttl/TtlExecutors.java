...
public final class TtlExecutors {
    ...
    @Nullable
    public static ThreadPoolExecutor getTtlThreadPoolExecutor(@Nullable ThreadPoolExecutor threadPoolExecutor) {
        if (TtlAgent.isTtlAgentLoaded() || threadPoolExecutor == null || threadPoolExecutor instanceof TtlEnhanced) {
            return threadPoolExecutor;
        }
        return new ThreadPoolExecutorServiceTtlWrapper(threadPoolExecutor, true);
    }
